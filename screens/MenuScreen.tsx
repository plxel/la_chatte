...
const menuItems = [
  ...
  },
  {
    ...
    price: 280,
    descr:
      "Омлет со сладким перцем, куриным филе и цукини. Подается с хрустящим тостом",
  },
  {
    id: 5,
    group: "Завтраки",
    ...
    price: 260,
    descr:
      "Омлет с сыром, беконом, шампиньонами, луком порей и томатами черри. Подается с хрустящим тостом",
  },
  {
    id: 6,
    group: "Завтраки",
